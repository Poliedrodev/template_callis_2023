$(document).ready(function () {
    $('.body').each(function () {        //Inicio do script para o componente
        ...
        //Inicio do script para o componente
        var containerVoceE = $('.container_collapsible_unificado');
        containerVoceE.on('click', function () {
            console.log('02');
            var randomId = Math.floor(Math.random() * 100000) + 1;
        ...
        var containerCollapsibleConheca = $('.container_collapsible_conheca');
        containerCollapsibleConheca.on('click', function () {
            console.log('02');
            var randomId = Math.floor(Math.random() * 100000) + 1;
